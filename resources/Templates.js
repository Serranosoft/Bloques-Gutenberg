const Templates = [
    ...
    },
    {
        ...
        <!-- /wp:column --></div>
        <!-- /wp:columns -->`,
        TemplateCss: ".template2{width:100%;display:flex;flex-wrap:wrap;transition:1s;background:0 0;padding:8px 4px}.template2 h3{font-size:24px;font-weight:700}.template2>div:first-child h3{color:#1b4d1b}.template2>div:nth-child(2) h3{color:#962424}.template2 ul{padding:0;list-style:none}.template2 ul>*{text-align:left}.template2 ul li{margin:10px 0;font-size:18px;list-style-position:inside}\n",
    ...
    },
    {
        ...
        <!-- /wp:table -->`,
        TemplateCss: ".template3{width:100%;margin:0 auto;border:1px solid #d3d3d3;padding:8px;overflow-x:auto;transition:1s;}.template3 table{width:100%;border-collapse:collapse}.template3 tr td {border:0;}.template3 tbody>tr:first-child td{font-size:26px;line-height:2.2;font-weight:bold;}@media(max-width:768px){.template3 tbody>tr:first-child td{line-height:1.5}.template3 tbody>tr:nth-child(2) td{display:block;margin:8px 0}.template3 tbody>tr:nth-child(3) td a{width:100%!important}}.template3 tbody>tr:nth-child(3) td a{display:block;width:65%;margin:18px auto;padding:10px 16px;border-radius:30px;background-color:#272c30;color:#fff;font-size:20px;text-decoration: none;}\n",
